/*
	Name: boardmap_skr_e3_dip_v1_0.h
	Description: Contains all MCU and PIN definitions for board SKR E3 DIP V1.0 to run µCNC.

	Copyright: Copyright (c) Alejandro Mora
...
#ifndef BOARDMAP_SKR_E3_DIP_V1_0_H
#define BOARDMAP_SKR_E3_DIP_V1_0_H
...
#ifndef BOARD_NAME
#define BOARD_NAME "SKR E3 DIP 1.0"
#endif
